                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="nom" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Nom" value="{{ $categorie->nom }}">
                            <small id="emailHelp" class="form-text text-muted">Nom Du categorie</small>
                        </div>

                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Niveau</label>
                            <select class="custom-select" id="select" name="level" onchange="reset_categorie()" @if ($categorie->parent)
                                selected="{{ $categorie->level }}"
                                @endif
                                >
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="custom-select" id="parent" name="categorie_id">
                                @if ($categorie->parent)
                                    <option value="{{ $categorie->parent->id }}">{{ $categorie->parent->nom }}</option>
                                @endif
                            </select>
                        </div>
